...
import com.tahsina.pages.writerPage;
...
public class WriterTest {
	...
	public void start() throws InterruptedException {
		...
		parentTest = report.createTest("<p style=\"color:#E40046; font-size:20px\"><b>WAFILIFE_AUTHOR</b></p>").assignAuthor("QA TEAM").assignDevice("Windows");
	}
